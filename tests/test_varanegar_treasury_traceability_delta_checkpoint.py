...
ROOT=Path(__file__).resolve().parents[1];B=ROOT/"scripts/windows/build_varanegar_treasury_traceability_delta_checkpoint_20260829.py";A=ROOT/"artifacts/varanegar_analysis/varanegar_treasury_traceability_delta_checkpoint_20260829.json"
