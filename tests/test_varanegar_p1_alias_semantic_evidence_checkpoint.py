...
ROOT=Path(__file__).resolve().parents[1];B=ROOT/"scripts/windows/build_varanegar_p1_alias_semantic_evidence_checkpoint_20260829.py";A=ROOT/"artifacts/varanegar_analysis/varanegar_p1_alias_semantic_evidence_checkpoint_20260829.json"
