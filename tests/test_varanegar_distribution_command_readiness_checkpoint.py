...
ROOT=Path(__file__).resolve().parents[1];B=ROOT/"scripts/windows/build_varanegar_distribution_command_readiness_checkpoint_20260829.py";A=ROOT/"artifacts/varanegar_analysis/varanegar_distribution_command_readiness_checkpoint_20260829.json"
...
def test_delta():assert load()["checks"]["five_to_six"] and load()["checks"]["runtime_zero"]
