...
ROOT=Path(__file__).resolve().parents[1];ARTIFACT=ROOT/"artifacts/varanegar_analysis/varanegar_reporting_output_expert_playbook_checkpoint_20260829.json"
...
def test_counts_runtime():
 c=load()["checks"];assert c["sources_pass"] and c["six_playbooks"] and c["nine_steps"] and c["runtime_zero"]
