...
ROOT=Path(__file__).resolve().parents[1];B=ROOT/"scripts/windows/build_varanegar_distribution_expert_playbook_checkpoint_20260829.py";A=ROOT/"artifacts/varanegar_analysis/varanegar_distribution_expert_playbook_checkpoint_20260829.json"
...
def test_scope():assert load()["checks"]["five_playbooks"] and load()["checks"]["eight_steps"] and load()["checks"]["four_and_twenty_eight"]
