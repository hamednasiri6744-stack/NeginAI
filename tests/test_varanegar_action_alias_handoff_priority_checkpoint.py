...
ROOT=Path(__file__).resolve().parents[1];BUILDER=ROOT/"scripts/windows/build_varanegar_action_alias_handoff_priority_checkpoint_20260829.py";ART=ROOT/"artifacts/varanegar_analysis/varanegar_action_alias_handoff_priority_checkpoint_20260829.json"
