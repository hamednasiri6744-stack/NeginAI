...
ROOT=Path(__file__).resolve().parents[1];BUILDER=ROOT/"scripts/windows/build_varanegar_p0_control_outcome_vocabulary_checkpoint_20260829.py";ART=ROOT/"artifacts/varanegar_analysis/varanegar_p0_control_outcome_vocabulary_checkpoint_20260829.json"
