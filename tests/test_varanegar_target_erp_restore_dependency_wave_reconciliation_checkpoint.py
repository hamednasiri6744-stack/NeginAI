...
BUILDER = ROOT / "scripts/windows/build_varanegar_target_erp_restore_dependency_wave_reconciliation_checkpoint_20260829.py"
CHECKPOINT = ROOT / "artifacts/varanegar_analysis/varanegar_target_erp_restore_dependency_wave_reconciliation_checkpoint_20260829.json"
...
def test_checkpoint_chain_and_safety():
    ...
    assert document["previous_checkpoint"]["path"].endswith("varanegar_target_erp_backup_restore_rehearsal_evidence_checkpoint_20260829.json")
