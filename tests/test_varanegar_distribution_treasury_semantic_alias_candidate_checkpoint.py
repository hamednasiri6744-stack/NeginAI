...
ROOT=Path(__file__).resolve().parents[1];BUILDER=ROOT/"scripts/windows/build_varanegar_distribution_treasury_semantic_alias_candidate_checkpoint_20260829.py";ART=ROOT/"artifacts/varanegar_analysis/varanegar_distribution_treasury_semantic_alias_candidate_checkpoint_20260829.json"
