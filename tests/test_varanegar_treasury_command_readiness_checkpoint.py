...
ROOT=Path(__file__).resolve().parents[1];B=ROOT/"scripts/windows/build_varanegar_treasury_command_readiness_checkpoint_20260829.py";A=ROOT/"artifacts/varanegar_analysis/varanegar_treasury_command_readiness_checkpoint_20260829.json"
...
def test_delta_pinned():assert load()["checks"]["four_to_five"] and load()["checks"]["runtime_zero"]
