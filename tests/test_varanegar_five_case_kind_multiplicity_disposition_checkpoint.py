...
ROOT=Path(__file__).resolve().parents[1];BUILDER=ROOT/"scripts/windows/build_varanegar_five_case_kind_multiplicity_disposition_checkpoint_20260829.py";ART=ROOT/"artifacts/varanegar_analysis/varanegar_five_case_kind_multiplicity_disposition_checkpoint_20260829.json"
