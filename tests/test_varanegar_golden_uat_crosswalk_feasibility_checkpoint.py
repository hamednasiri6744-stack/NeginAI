...
ROOT=Path(__file__).resolve().parents[1];BUILDER=ROOT/"scripts/windows/build_varanegar_golden_uat_crosswalk_feasibility_checkpoint_20260829.py";ART=ROOT/"artifacts/varanegar_analysis/varanegar_golden_uat_crosswalk_feasibility_checkpoint_20260829.json"
