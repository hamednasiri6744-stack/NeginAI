...
ROOT=Path(__file__).resolve().parents[1];BUILDER=ROOT/"scripts/windows/build_varanegar_p1_alias_baseline_candidate_checkpoint_20260829.py";ART=ROOT/"artifacts/varanegar_analysis/varanegar_p1_alias_baseline_candidate_checkpoint_20260829.json"
