...
ROOT=Path(__file__).resolve().parents[1];BUILDER=ROOT/"scripts/windows/build_varanegar_unmatched_golden_case_alias_work_queue_checkpoint_20260829.py";ART=ROOT/"artifacts/varanegar_analysis/varanegar_unmatched_golden_case_alias_work_queue_checkpoint_20260829.json"
