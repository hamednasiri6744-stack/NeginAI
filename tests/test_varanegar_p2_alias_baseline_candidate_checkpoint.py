...
R=Path(__file__).resolve().parents[1];B=R/"scripts/windows/build_varanegar_p2_alias_baseline_candidate_checkpoint_20260829.py";A=R/"artifacts/varanegar_analysis/varanegar_p2_alias_baseline_candidate_checkpoint_20260829.json"
