...
R=Path(__file__).resolve().parents[1];B=R/"scripts/windows/build_varanegar_p2_final_evidence_gap_status_checkpoint_20260829.py";A=R/"artifacts/varanegar_analysis/varanegar_p2_final_evidence_gap_status_checkpoint_20260829.json"
