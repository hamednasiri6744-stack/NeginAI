...
R=Path(__file__).resolve().parents[1];B=R/"scripts/windows/build_varanegar_p3_alias_semantic_evidence_checkpoint_20260829.py";A=R/"artifacts/varanegar_analysis/varanegar_p3_alias_semantic_evidence_checkpoint_20260829.json"
