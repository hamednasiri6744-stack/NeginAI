"""Chain the 56 reporting/output Golden/UAT case designs."""
...
SOURCES = {
    ...
    "builder": "scripts/windows/build_varanegar_reporting_output_golden_uat_cases_20260829.py",
    "checkpoint_builder": "scripts/windows/build_varanegar_reporting_output_golden_uat_checkpoint_20260829.py",
    "test": "tests/test_varanegar_reporting_output_golden_uat_cases.py",
    "checkpoint_test": "tests/test_varanegar_reporting_output_golden_uat_checkpoint.py",
    "doc": "docs/varanegar_reconstruction/REPORTING_OUTPUT_GOLDEN_UAT_CASES_20260829_FA.md",
}
...
def main():
    ...
    checks = {
        ...
        "eight_by_seven": summary["command_surface_count"] == 8 and summary["case_count"] == 56 and summary["case_count_per_surface"] == 7,
