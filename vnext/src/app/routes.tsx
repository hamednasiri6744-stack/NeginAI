...
export const appRoutes: readonly AppRouteDefinition[] = [
  ...
  { id: 'seller-map', path: '/seller/map', primary: 'modules', screen: SellerMapScreen, traceId: 'MAP-01', contractStatus: 'VERIFIED' },
  ...
  { id: 'seller-cart', path: '/seller/cart', primary: 'modules', screen: CartScreen, traceId: 'ORD-04', contractStatus: 'VERIFIED' },
