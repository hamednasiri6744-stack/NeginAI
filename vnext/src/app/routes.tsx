...
export const appRoutes: readonly AppRouteDefinition[] = [
  ...
  { id: 'seller-day-route', path: '/seller/day-route', primary: 'modules', screen: SellerDayRouteScreen, traceId: 'SEL-02', contractStatus: 'NEEDS_VALIDATION' },
  { id: 'seller-customers', path: '/seller/customers', primary: 'modules', screen: SellerRouteCustomersScreen, traceId: 'SEL-03', contractStatus: 'NEEDS_VALIDATION' },
