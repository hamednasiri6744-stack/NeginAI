...
export function VisitorNeshanMap({routeId,mode,selectedCustomerId,recenterNonce,onSelectCustomer,onPrimaryCustomer,onNotice,onOrderChange}:Props){
  ...
  return <div ref={shell} className={'vr-map-live-shell'+(fullscreen?' is-fullscreen':'')}>
    ...
    <details className="vr-map-mobile-tools">
      <summary aria-label={'\u0627\u0628\u0632\u0627\u0631 \u0646\u0642\u0634\u0647'}><span aria-hidden="true">{'\u2630'}</span><b>{'\u0627\u0628\u0632\u0627\u0631\u0647\u0627'}</b></summary>
    ...
    <div className="vr-map-toolbox"><button type="button" onClick={centerOnMe} aria-label={'\u0645\u0631\u06a9\u0632 \u0631\u0648\u06cc \u0645\u0646'}><b>{'\u25ce'}</b><span>{'\u0645\u0631\u06a9\u0632 \u0631\u0648\u06cc \u0645\u0646'}</span></button><button type="button" onClick={fitRouteView} aria-label={'\u0646\u0645\u0627\u06cc\u0634 \u06a9\u0644 \u0645\u0633\u06cc\u0631'}><b>{'\u2317'}</b><span>{'\u06a9\u0644 \u0645\u0633\u06cc\u0631'}</span></button><button type="button" onClick={()=>void toggleFullscreen()} aria-label={'\u0646\u0642\u0634\u0647 \u062a\u0645\u0627\u0645 \u0635\u0641\u062d\u0647'}><b>{fullscreen?'\u2715':'\u26f6'}</b><span>{fullscreen?'\u0628\u0633\u062a\u0646':'\u062a\u0645\u0627\u0645 \u0635\u0641\u062d\u0647'}</span></button></div>
